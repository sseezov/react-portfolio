      ...
      <div className="container-about">
        <div className="text-zone">
          ...
          <p style={{ fontSize: '15px' }}>
            ...
            интерфейсов и алгоритмов. В ходе учебы я закончил множество модулей
            на freecodecamp.org, модули theodinproject.com, задачи на ts.checkio
            и т.п.
          </p>
          <p style={{ fontSize: '15px' }}>
